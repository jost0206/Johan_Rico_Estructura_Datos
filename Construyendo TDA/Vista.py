...
class VistaLista:
    def __init__(self, controlador):
        ...
        self.root = tk.Tk()
        self.root.title("Lista doble / MVC")
        ...
        self.boton_listar_a_izquierda=tk.Button(self.root, text="Listar hacia la izquierda <-", command=self.controlador.listar_a_izquierda)
        ...
        self.boton_listar_a_izquierda.pack(pady=5)
